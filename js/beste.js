...
/*---------delay----------*/
$('.container').delay(100).animate({'opacity':'1'},10);
$('img').delay(4050).animate({'opacity':'1'},500);
$('#videoid').delay(500).animate({'opacity':'0.5'},3000);
/*---------$('#videoid').delay(40000).animate({'opacity':'0'},500);----------*/
$('.exo-menu').delay().animate({'opacity':'0.95'},1500);
$('.time').delay().animate({'opacity':'0.95'},1500);
$('svg').delay().animate({'opacity':'1'},10);
/*---------$('.image').delay(42000).animate({'opacity':'0.5'},500);----------*/
...
var x=0;var titleText=["RAVERSAR","top eu","ahk","RAVERSAR","CIS","FPL","RAVERSAR","1tap","yea bitch","$$$"];
function loop(){document.getElementsByTagName("title")[0].innerHTML=titleText[x++%titleText.length];}
